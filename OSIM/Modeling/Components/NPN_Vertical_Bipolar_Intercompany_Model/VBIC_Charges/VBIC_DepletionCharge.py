...
class VBIC_DepletionCharge(Charge):
    ...
    def __init__(self, nodes, name, value, superComponent, **kwargs):
        ...
        self.CJx = self.paramDict.get("CJx", 4.2E-15) #0-V Sperrschichtkapazitaet
        self.P = self.paramDict.get("P", 0.62)
        self.M = self.paramDict.get("M", 0.12)
        self.F = self.paramDict.get("F", 0.97)
        self.AJ = self.paramDict.get("AJ", -0.5)
